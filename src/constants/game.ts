export const GAME_CONFIG = {
  ...
  // Visual - OpenAgent-Inspired Cyber Fleet Theme
  BRAND_COLORS: {
  ...
  BACKGROUND_COLOR: "#0A0A1F", // OpenAgent Dark
  PLATFORM_COLOR: "#0066FF", // OpenAgent Blue
  FALLBACK_PLAYER_COLOR: "#00D4FF", // OpenAgent Cyan
